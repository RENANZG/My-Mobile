...
#######################################################################
# File Name    : install_scrcpy_appimage.sh
...
#                  chmod +x install_scrcpy_appimage.sh
#                • Run the script with:
#                  bash install_scrcpy_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/scrcpy/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/scrcpy/remove.sh
...
# Define variables
APP_NAME="scrcpy"
APP_DOWNLOAD_URL="https://api.github.com/repos/srevinsaju/scrcpy-appimage/releases"
