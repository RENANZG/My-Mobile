...
#######################################################################
# File Name    : install_firetv_toolkit_appimage.sh
...
#                  chmod +x install_firetv_toolkit_appimage.sh
#                • Run the script with:
#                  bash install_firetv_toolkit_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/firetv-toolkit/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/firetv-toolkit/remove.sh
...
# Define variables
APP_NAME="firetv-toolkit"
APP_DOWNLOAD_URL="https://api.github.com/repos/AnthonyGress/Android-Toolkit/releases"
