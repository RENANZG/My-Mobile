...
#######################################################################
# File Name    : install_uad_ng_appimage.sh
...
#                  chmod +x install_uad_ng_appimage.sh
#                • Run the script with:
#                  bash install_uad_ng_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/uad-ng/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/uad-ng/remove.sh
...
# Define variables
APP_NAME="uad-ng"
APP_DOWNLOAD_URL="https://api.github.com/repos/Universal-Debloater-Alliance/universal-android-debloater-next-generation/releases"
