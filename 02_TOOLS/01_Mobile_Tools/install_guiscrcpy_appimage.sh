...
#######################################################################
# File Name    : install_guiscrcpy_appimage.sh
...
#                  chmod +x install_guiscrcpy_appimage.sh
#                • Run the script with:
#                  bash install_guiscrcpy_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/guiscrcpy/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/guiscrcpy/remove.sh
...
# Define variables
APP_NAME="guiscrcpy"
APP_DOWNLOAD_URL="https://api.github.com/repos/srevinsaju/guiscrcpy/releases"
