...
#######################################################################
# File Name    : install_air_controller_desktop_appimage.sh
...
#                  chmod +x install_air_controller_desktop_appimage.sh
#                • Run the script with:
#                  bash install_air_controller_desktop_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/air-controller-desktop/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/air-controller-desktop/remove.sh
...
# Define variables
APP_NAME="air-controller-desktop"
APP_DOWNLOAD_URL="https://api.github.com/repos/air-controller/air-controller-desktop/releases"
