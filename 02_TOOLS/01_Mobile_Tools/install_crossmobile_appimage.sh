...
#######################################################################
# File Name    : install_crossmobile_appimage.sh
...
#                  chmod +x install_crossmobile_appimage.sh
#                • Run the script with:
#                  bash install_crossmobile_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/crossmobile/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/crossmobile/remove.sh
...
# Define variables
APP_NAME="crossmobile"
APP_DOWNLOAD_URL="https://api.github.com/repos/crossmob/CrossMobile/releases"
